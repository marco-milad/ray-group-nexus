export const servicesCopy = {
  seo: {
    ...
    description: 'Full-spectrum diagnostic services across MRI, CT, PET-CT, Ultrasound, Mammography, Lab Services, and more.',
  },
  hero: {
    eyebrow:        'Diagnostic Services',
    headline:       'Full-Spectrum',
    headlineAccent: 'Diagnostic Excellence.',
    subheadline:    'From routine imaging to advanced nuclear medicine — Ray Lab Group delivers accurate, consultant-led diagnostics across every clinical pathway.',
  },
  stats: {
  ...
  pathways: {
    ...
    items: [
      'Neurology', 'Oncology', 'Orthopaedics', 'Spine & Back Pain',
      'Trauma', 'Pre-operative Planning', 'Paediatrics',
      'Cardiology', "Women's Health", 'Endocrinology',
    ],
  },
  featured: {
    imaging: {
