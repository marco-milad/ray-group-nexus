export const platformsCopy = {
  seo: {
    ...
    description:
      "Explore Ray Lab Group's 6 diagnostic platforms across Egypt, Saudi Arabia, and Jordan.",
  },
  hero: {
    ...
    subheadline:
      "Select a platform to explore its services, locations, and role within the Ray Lab Group ecosystem.",
  },
  overview: {
    eyebrow: "The Group Portfolio",
    headline: "Built for Scale. Designed for Precision.",
    subheadline:
      "Each brand operates independently within its market — unified under Ray Lab Group's standards of diagnostic excellence.",
  },
  brandPage: {
