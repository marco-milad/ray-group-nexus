...
export const investorsCopy = {
  seo: {
    ...
    description: 'Ray Lab Group investor relations — investment thesis, financial performance, shareholder structure, growth strategy, and governance.',
  },
  ...
  hero: {
    ...
    subheadline:    "Ray Lab Group is the MENA region's most geographically diverse private diagnostic group — backed by leading development finance institutions and growing across Egypt, Saudi Arabia, and Jordan.",
  ...
  thesis: {
    ...
    subheadline:'Four structural advantages that make Ray Lab Group a compelling diagnostic platform investment in MENA — each backed by demonstrated operational evidence.',
    pillars: [
      {
        number:     '01',
        ...
        soWhat:     'First-mover consolidation advantage in a market with no comparable multi-country operator — creating a defensible competitive moat.',
      },
      {
        number:     '02',
        ...
        soWhat:     'Revenue is recurring, predictable, and structurally insulated from economic cycles — a rare characteristic in MENA private healthcare.',
      },
      {
        number:     '03',
        ...
        soWhat:     'Capital-efficient growth model where marginal branches generate high incremental contribution — not high incremental overhead.',
      },
      {
        number:     '04',
        ...
        soWhat:     'Institutional backing signals rigorous due diligence, ESG compliance, and governance standards that align with international co-investment requirements.',
      },
    ],
  },
  ...
  performance: {
    ...
    subheadline:'Record year across all key metrics — driven by Egypt expansion and growing teleradiology demand.',
    metrics: [
      {
        value:    '$36.2M',
        label:    'Total Operating Revenue',
        note:     '2025 full year',
        soWhat:   'Demonstrating strong recurring demand across core markets — with teleradiology and clinics as emerging growth contributors.',
      },
      {
        value:    '1.6M+',
        label:    'Diagnostic Exams Performed',
        note:     'Across all platforms',
        soWhat:   'Volume at this scale indicates entrenched physician referral relationships and strong brand recall across patient populations.',
      },
      {
        value:    '344K',
        label:    'Lab Tests Performed',
        note:     'Cairo Scan + TechnoScan',
        soWhat:   'Lab expansion (launched 2012) has become a material revenue contributor — with significantly higher margin per interaction than imaging.',
      },
      {
        value:    '12',
        label:    'New Branches Launched',
        note:     'Egypt 2025 — Delta, Canal, Upper Egypt',
        soWhat:   'Fastest single-year expansion in group history — proving the hub-and-spoke model scales beyond Cairo into underserved markets.',
      },
    ],
    ...
    revenueBreakdown: {
      ...
      items: [
        ...
        { label: 'Laboratory Services', value: 22, display: '~22%', note: 'Higher margin per test'  },
  ...
  shareholders: {
    ...
    subheadline:"Ray Lab Group's shareholder base reflects the highest standards of international development finance — providing long-term capital, ESG oversight, and governance credibility that signals quality to any prospective co-investor.",
    combinedPortfolio: {
      value:    '€79.3B+',
      label:    'Combined Institutional Portfolio',
      sublabel: 'Across all 5 institutional shareholders',
      soWhat:   'This level of institutional backing represents rigorous independent due diligence — each DFI applied its own investment committee process before committing.',
    },
    credibilitySignals: {
  ...
  strategy: {
    ...
    subheadline:'Ray Lab Group\'s growth is driven by three concurrent, mutually reinforcing strategies — each contributing to scale, margin improvement, and competitive advantage.',
    vectors: [
      {
        number: '01',
        ...
        soWhat: 'Each new branch enters a market with existing physician referral demand and brand recognition — reducing customer acquisition cost to near zero.',
      },
      {
        number: '02',
        ...
        soWhat: 'Vertical integration increases revenue per patient episode, reduces referral leakage to competitors, and creates a defensible care ecosystem.',
      },
      {
        number: '03',
        ...
        soWhat: 'Teleradiology decouples revenue growth from headcount growth — the platform scales horizontally across any number of hospital clients with minimal marginal cost.',
      },
    ],
  },
  ...
  risks: {
    ...
    subheadline:'Transparent risk disclosure is a hallmark of institutional-grade governance. Below are the key risks we monitor — and the structural mitigants in place.',
    items: [
      {
        risk:       'Market Fragmentation',
        mitigation: 'Consolidation strategy with proven hub-and-spoke execution. Ray Lab is already the largest multi-country diagnostic operator in the region — scale itself is the moat.',
        status:     'Actively managed',
      },
      {
        risk:       'Talent & Consultant Dependency',
        mitigation: 'Consultant-led network model reduces single-physician risk. 60+ consultants across Ray Medical alone. Teleradiology enables subspecialty access without geographic constraints.',
        status:     'Structurally mitigated',
      },
      {
        risk:       'Geographic & Political Risk',
        mitigation: 'Multi-country diversification across Egypt, KSA, and Jordan ensures no single-market dependency. Malta HQ provides EU legal standing and international arbitration access.',
        status:     'Diversified',
      },
      {
        risk:       'Regulatory & Payer Risk',
        mitigation: 'Diversified payer mix (insured, corporate, self-pay) reduces dependency on any single reimbursement scheme. DFI backing enforces compliance standards across all markets.',
        status:     'Diversified',
      },
      {
        risk:       'Execution Risk at Scale',
        mitigation: 'Hub-and-spoke model is proven — 12 branches launched in 2025 with operational continuity maintained. Shared infrastructure (Ray Medical, physician portal) reduces per-branch complexity.',
    ...
    milestones: [
      {
        ...
        soWhat:  'Validates hub-and-spoke scalability beyond Cairo — now the only diagnostic brand with meaningful Upper Egypt presence.',
      },
      {
        status:  'done',
        year:    '2026',
        ...
        soWhat:  'Proves the model replicates across different regulatory environments and physician ecosystems.',
      },
      {
        status:  'done',
        year:    '2026',
        ...
        soWhat:  'Opens a new scalable B2B revenue stream — any hospital becomes a potential client without capital investment.',
      },
      {
        status:  'active',
        year:    '2026',
        ...
        soWhat:  'KSA is the highest-revenue private healthcare market in the region — CRC\'s consultant-led positioning is premium in a quality-sensitive market.',
      },
      {
        status:  'active',
        year:    '2026',
        ...
        soWhat:  'Each new hospital client is low-cost to acquire and high-margin to serve — the B2B teleradiology model compounds as the network grows.',
      },
      {
        status:  'planned',
        year:    '2027',
        ...
        soWhat:  'UAE represents the highest GDP-per-capita private healthcare market in MENA — a premium positioning opportunity for the Ray Lab brand.',
      },
    ],
  },
  ...
  exit: {
    ...
    subheadline:'Ray Lab Group is building the defining private diagnostic platform across MENA — with a capital structure, governance framework, and operational model designed for institutional-scale value creation.',
    statements: [
      {
  ...
  governance: {
    ...
    subheadline:"Ray Lab Group's EU-based holding structure reflects the governance requirements of its DFI shareholders — providing transparency, compliance, and institutional reporting practices across all markets.",
    standards: [
      { label: 'Reporting Standards',   value: 'International accounting practices with institutional-grade financial reporting.' },
      { label: 'DFI Compliance',        value: 'EBRD, FMO, Proparco, and DEG compliance frameworks applied across all operations.' },
      { label: 'ESG Framework',         value: 'Environmental, social, and governance monitoring mandated by DFI investment terms.' },
      { label: 'Legal Jurisdiction',    value: 'Malta (EU) — providing access to international arbitration and EU regulatory standing.' },
    ],
    details: {
  ...
  press: {
    ...
    articles: [
      { category: 'Expansion',  headline: 'TechnoScan Opens 3 New Branches in Upper Egypt',              date: 'March 2025'    },
      { category: 'Technology', headline: 'LUMINA 3T Tesla MRI Now Available at 8 Cairo Scan Locations', date: 'February 2025' },
      { category: 'Clinics',    headline: 'TechnoScan Specialized Clinics Launches Across Cairo',        date: 'January 2025'  },
      { category: 'Expansion',  headline: 'MedRay Jordan Expands to 7th Branch in Abdoun District',      date: 'December 2024' },
    ],
  },
