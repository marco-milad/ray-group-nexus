...
export function PathwaysSection() {
  ...
  const handleMouseLeave = (id: string) => {
    // لو الـ card مقفولة بالضغط — مش بيقفلها الـ hover
          ...
          {items.map((p, i) => {
            ...
            return (
              <Reveal key={p.id} delay={i * 70}>
                <article
                  className="rounded-2xl border border-border/60 bg-card overflow-hidden transition-all duration-300 hover:shadow-lg cursor-pointer select-none"
                  style={{
                ...
                >
                  ...
                  >
                    <div className="px-5 pb-5 pt-1 border-t" style={{ borderColor: `${color}20` }}>
                      <div
